...
end_date = time_utils.strptime_to_utc_datetime('2021-12-31 11:59:59.0')
...
catalog_California1 = cat.filter_spatial(NEOKINEMA_f.region, in_place=False)
...
catalog_sC = np.sort(catalog_Cali1.data, order=['magnitude']) 
